...
def interpolated_prior(bot_problem_dict, beta):
    """
    Compute the interpolated prior solution for the Branched Optimal Transport (BOT) problem.
    ...
    Returns:
        MST_joint (networkx.Graph): The interpolated prior solution represented as a tree topology.
