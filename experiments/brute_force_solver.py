...
def wrapper_fct_for_multithreading(bot_problem_dict, topo_list):
    ...
    for i,topo in enumerate(topo_list):
        _, cost, _, _ = fast_optimize(topo, supply_arr, demand_arr, coords_sources, coords_sinks, al,
...
if __name__ == '__main__':
    ...
    for dim in dim_arr:
        # init pickle file:
        pkl_file_path = f"../results/output_files/brute-force_dim{dim}_results{N}.pkl"
        data_dict = {}
