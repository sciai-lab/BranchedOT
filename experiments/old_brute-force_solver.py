...
if __name__ == '__main__':
    ...
    pkl_file_path = f"../results/output_files/brute-force_results{N}.pkl"
    data_dict = {}
    ...
    for k in range(N):
        ...
        for num_terminals in terminals_list:
            ...
            bot_problem_dict = helper_fcts.generate_random_bot_problem(num_sources, num_sinks, normalised_to=1, dim=2,
                                                           max_length=1.)

            # generate all topos:
            all_topos = helper_fcts.get_random_topos_sparsely(bot_problem_dict, num_topos)
