...
def wrapper_fct_for_multithreading(num_terminals, seed_list):
    ...
    for i, seed in enumerate(seed_list):
        ...
        results[i] = {}
        for kernel_width in kernel_width_arr:
            ...
            print(f"completed problem {i} with num_terminals={num_terminals}.")
...
if __name__ == '__main__':
    for num_terminals in num_terminals_arr:
        ...
        pkl_file_path = f"MC_star_kernelwidth_probs{num_problems}_size{num_terminals}_new.pkl"
